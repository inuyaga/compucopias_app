...
import 'package:compucopias_app/widgets/cards_productos.dart';
...
class _SearchViewProductoState extends State<SearchViewProducto> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
            ...
            child: Padding(
              ...
              child: TextFormField(
                ...
                onFieldSubmitted: (value) {
                  if (value != '') {
                    setState(() {
                      resultado = CardGridWidget(
                        searchtype: value,
                        updateNotificacion: this.widget.updateNotificacion,
                      );
                    });
                  }
                },
      ...
      body: Container(
        child: Padding(padding: EdgeInsets.all(10), child: resultado),
      ),
    );
  }
}
