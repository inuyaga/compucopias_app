...
import 'package:compucopias_app/paginas/selected_categoria.dart';
...
class _CategoriasWidgetState extends State<CategoriasWidget> {
            ...
            return SizedBox(
              ...
              child: ListView.builder(
                  ...
                  itemBuilder: (BuildContext context, int index) =>
                      buidCategoria(index, snap.data[index],
  ...
  Widget buidCategoria(
      int index, AreaObject areaObj, VoidCallback updateNotificacion) {
    return GestureDetector(
      onTap: () {
        ...
        Navigator.push(
            context,
            MaterialPageRoute(
                builder: (context) => SelectedCategoriaProductos(
                      busquedaID: "${areaObj.id}",
                      nombreCategoria: areaObj.nombre,
