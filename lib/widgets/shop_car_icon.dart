import 'package:compucopias_app/paginas/shopingCar.dart';
        ...
        IconButton(
            ...
            onPressed: () {
              Navigator.of(context)
                  .push(
                      MaterialPageRoute(builder: (context) => ShopingCarView()))
                  .then((value) => this.widget.updateNotificacion());
            }),
        Positioned(
            top: 7,
            right: 4,
            ...
            child: SizedBox(
              ...
              height: 15,
              child: Text(
                this.widget.conteoCompra > 0
                    ? "${this.widget.conteoCompra}"
                    : "",
                style: TextStyle(
                    color: Colors.red,
